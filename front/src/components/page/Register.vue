        ...
        <div class="ms-login">
            ...
            <el-form :model="param" :rules="rules" ref="register" label-width="0px" class="ms-content">
                <el-form-item prop="phone" label="手机号" label-width="90px">
                    <el-input v-model="param.phone" placeholder="手机号"> </el-input>
                </el-form-item>
                ...
                <el-form-item prop="repassword" label="确认密码" label-width="90px">
                    <el-input type="password" placeholder="确认密码" v-model="param.repassword" @keyup.enter.native="submitForm()">
                    </el-input>
                </el-form-item>
                <el-form-item prop="name" label="姓名" label-width="90px">
            ...
            <div class="login-bottom">
                <span style="float: right; margin: 0 15px 15px 0; font-size: 10px"
                    ><a style="color: rgb(255 255 255)" href="/#/login">去登录</a></span
                >
            </div>
        </div>
    </div>
