    ...
    <div>
        ...
        <el-dialog title="部门编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="ruleForm" :model="eform" :rules="rules" label-width="90px">
                ...
                <el-form-item label="备注" >
                    <el-input type="textarea" v-model="eform.remark"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="部门添加" :visible.sync="addVisible" width="30%">
            <el-form ref="ruleForm" :model="aform" :rules="rules" label-width="90px">
                ...
                <el-form-item label="备注" >
                    <el-input type="textarea" v-model="aform.remark"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$axios.post('/api/department/selectAll',param).then(res => {
            ...
            handleDelete(index, row) {
                this.$confirm('确定要删除吗？', '提示', {
                    type: 'warning'
                        ...
                        this.$axios.get('/api/department/deleteById?id=' + row.id).then(res => {
            ...
            saveEdit(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$axios.post('/api/department/edit', this.eform).then(res => {
                            if(res.data == '200'){
            ...
            saveAdd(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post('/api/department/add', this.aform).then(res => {
                            if(res.data == '200'){
